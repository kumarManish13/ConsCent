...
function Info() {
    ...
    return (
        ...
        <div style={{ display: "flex", flexWrap: "wrap", flexDirection: "row", backgroundImage: `url(${background4})`,
        backgroundSize: 'cover',
        backgroundRepeat: 'no-repeat', height: "700px",marginBottom:"200px",marginRight:"170px",marginTop:"200px",marginLeft:"130px"}}>
